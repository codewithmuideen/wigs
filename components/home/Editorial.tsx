  ...
  return (
    <section className="mx-auto max-w-[1440px] px-4 py-20 sm:px-6 lg:px-10">
      <div className="grid overflow-hidden rounded-sm bg-burgundy lg:grid-cols-2">
        <div className="relative order-1 aspect-[4/5] min-h-[22rem] lg:order-none lg:aspect-auto">
          <Image
            src="/images/wigs/w-wall-of-wigs.jpg"
            alt="The Fèyíshọpé Luxe Luxury Collection"
            fill
